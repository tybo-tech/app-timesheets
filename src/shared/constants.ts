...
export const COMPANY_EMIAL = 'otarogboru@outlook.com, mrnnmthembu@gmail.com';
export const COMPANY_ID = 'aca01da6-9ce7-11eb-8221-ac1f6bd0427e';
export const COMPANY_NAME = 'Tayi Team';
...
export const SEND_EMAIL_RESET_PASSWORD  = 'https://tayihealthcare.com/api/api/email/email-reset-password-link.php';
export const SEND_EMAIL_ACTIVATE_ACCOUNT = 'https://tayihealthcare.com/api/api/email/email-welcome-activate-account.php';
export const SEND_EMAIL_GENERAL_TEXT = 'https://tayihealthcare.com/api/api/email/general-email.php';
export const SEND_EMAIL_BILLING = 'https://tayihealthcare.com/api/api/email/email-billing.php';
